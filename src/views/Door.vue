...
const products = ref([
  ...
  { id: 2, name: '設計款大門', shortDesc: '', imageName: '木門1.jpg' },
  { id: 3, name: '木門貼膜', shortDesc: '', imageName: '木門1.jpg' },
  { id: 4, name: '設計工法展示', shortDesc: '', imageName: '木門1.jpg' },
  { id: 5, name: '高端木作工法', shortDesc: '', imageName: '木門1.jpg' },
  { id: 6, name: '經典木門', shortDesc: '', imageName: '木門1.jpg' },
  { id: 7, name: '時尚木門', shortDesc: '', imageName: '木門1.jpg' },
  { id: 8, name: '防火木門', shortDesc: '', imageName: '木門1.jpg' },
  { id: 9, name: '隔音木門', shortDesc: '', imageName: '木門1.jpg' },
  { id: 10, name: '客製木門', shortDesc: '', imageName: '木門1.jpg' },
])
...
const colors = ref([
  ...
  { id: 5, name: '胡桃木色', shortDesc: '深沉典雅的高級木質色調。', imageName: 'color1.jpg' },
  { id: 6, name: '楓木色', shortDesc: '溫潤自然,適合各式風格。', imageName: 'color2.jpg' },
  { id: 7, name: '白橡色', shortDesc: '明亮輕盈,呈現北歐氛圍。', imageName: 'color3.jpg' },
  { id: 8, name: '黑胡桃色', shortDesc: '穩重高雅,彰顯個人品味。', imageName: 'color4.jpg' },
  { id: 1, name: '胡桃木色', shortDesc: '深沉典雅的高級木質色調。', imageName: 'color1.jpg' },
  { id: 2, name: '楓木色', shortDesc: '溫潤自然,適合各式風格。', imageName: 'color2.jpg' },
  { id: 3, name: '白橡色', shortDesc: '明亮輕盈,呈現北歐氛圍。', imageName: 'color3.jpg' },
  { id: 4, name: '黑胡桃色', shortDesc: '穩重高雅,彰顯個人品味。', imageName: 'color4.jpg' },
